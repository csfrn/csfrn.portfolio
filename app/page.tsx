...
const education = [
  {
    ...
    period: "",
    description:
      "Focus on cloud-native systems, networking, security, and automation. Received Excellence Award in Systems Thinking.",
  },
]
    ...
    <ClickSpark sparkSize={10} sparkRadius={15} sparkCount={8} duration={400}>
      <div className="min-h-screen">
          ...
          <nav className="container mx-auto px-6 py-4 flex items-center justify-between max-w-6xl">
            ...
            <div className="flex items-center gap-6">
              <div className="hidden md:flex items-center gap-6">
                {navLinks.map((l) => (
                  <Link key={l.href} href={l.href} className="text-sm font-medium hover:opacity-60 transition-opacity">
                    {l.label}
                  </Link>
                ))}
              </div>
        ...
        <main className="container mx-auto px-6 pt-24 max-w-4xl">
          {/* Intro */}
          <section id="intro" className="min-h-[70vh] flex flex-col justify-center py-20 scroll-mt-24">
            ...
            <div className="flex flex-col md:flex-row gap-8 items-start">
              ...
              <div className="flex-1">
                ...
                <p className="text-lg md:text-xl leading-relaxed opacity-80 mt-4">
                  Outside work, I keep learning and building side projects and I make time to unplug, travel, and enjoy
                  life off-screen.
                </p>
              </div>
            </div>
          ...
          {/* Projects */}
          <section id="projects" className="py-20 border-t border-foreground scroll-mt-24">
          ...
          {/* Certifications */}
          <section id="certifications" className="py-20 border-t border-foreground scroll-mt-24">
          ...
          {/* Experience */}
          <section id="experience" className="py-20 border-t border-foreground scroll-mt-24">
          ...
          {/* Education */}
          <section id="education" className="py-20 border-t border-foreground scroll-mt-24">
          ...
          {/* Contact */}
          <section id="contact" className="py-20 border-t border-foreground scroll-mt-24">
