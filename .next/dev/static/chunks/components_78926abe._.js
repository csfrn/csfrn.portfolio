...
function MagneticCursor() {
    _s();
    const cursorRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const dotRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const mouse = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])({
        x: 0,
        y: 0
    });
    const pos = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])({
        x: 0,
        y: 0
    });
    const target = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])({
        x: 0,
        y: 0
    });
    const hoveredEl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const isHoveringMagnetic = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(false);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MagneticCursor.useEffect": ()=>{
            ...
            const onOver = {
                "MagneticCursor.useEffect.onOver": (e)=>{
                    const el = e.target?.closest?.("[data-magnetic]");
                    hoveredEl.current = el;
                    isHoveringMagnetic.current = !!el;
                    if (el) {
                        cursor.classList.add("scale-150");
                        dot.classList.add("scale-0");
                    }
                }
            }["MagneticCursor.useEffect.onOver"];
            const onOut = {
                "MagneticCursor.useEffect.onOut": (e)=>{
            ...
            }["MagneticCursor.useEffect.onOut"];
            const animate = {
                "MagneticCursor.useEffect.animate": (t)=>{
                    const dt = Math.min((t - last) / 1000, 0.033);
                    last = t;
                    // base target is the mouse
                    target.current.x = mouse.current.x;
                    target.current.y = mouse.current.y;
                    // magnetic pull toward element center
                    if (isHoveringMagnetic.current && hoveredEl.current) {
                        const rect = hoveredEl.current.getBoundingClientRect();
                        const cx = rect.left + rect.width / 2;
                        const cy = rect.top + rect.height / 2;
                        // pull strength: 0..1 (bigger = stickier)
                        const strength = 0.35;
                        // also use mouse distance from center to create a "tension" feel
                        const dx = mouse.current.x - cx;
                        const dy = mouse.current.y - cy;
                        const max = Math.max(rect.width, rect.height) * 0.75;
                        const dist = Math.hypot(dx, dy);
                        const falloff = 1 - clamp(dist / max, 0, 1);
                        target.current.x = lerp(mouse.current.x, cx, strength * falloff);
                        target.current.y = lerp(mouse.current.y, cy, strength * falloff);
                        // subtle element nudge (optional but nice)
                        const nudge = 10 * falloff;
                        hoveredEl.current.style.transform = `translate(${dx * 0.06}px, ${dy * 0.06}px)`;
                        hoveredEl.current.style.transition = "transform 120ms ease-out";
                        hoveredEl.current.style.willChange = "transform";
                        hoveredEl.current.style.setProperty("--magnetic-nudge", `${nudge}px`);
                    }
                    // smooth cursor follow (time-based-ish)
                    const follow = 1 - Math.pow(0.001, dt) // stable across FPS
                    ;
                    pos.current.x = lerp(pos.current.x, target.current.x, follow);
                    pos.current.y = lerp(pos.current.y, target.current.y, follow);
            ...
            }["MagneticCursor.useEffect.animate"];
            ...
            return ({
                "MagneticCursor.useEffect": ()=>{
                    ...
                    // clean any leftover transform on hovered element
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ref: cursorRef,
                className: "fixed left-0 top-0 z-[9999] pointer-events-none h-8 w-8 -translate-x-1/2 -translate-y-1/2 rounded-full border border-black/80 transition-transform duration-150",
                style: {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ref: dotRef,
                className: "fixed left-0 top-0 z-[9999] pointer-events-none h-2 w-2 -translate-x-1/2 -translate-y-1/2 rounded-full bg-black/90 transition-transform duration-150",
                style: {
                    mixBlendMode: "difference"
                }
            }, void 0, false, {
...
_s(MagneticCursor, "pP24//uF0ytKH26/Td4x+9lAikk=");
_c = MagneticCursor;
var _c;
